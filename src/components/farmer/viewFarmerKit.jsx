...
import { deleteProduce, getFarmerKitList } from "../../services/farmerService";
...
class ViewFarmerKit extends Component {
  constructor(props) {
    super(props);
    this.state = {
      productArr: [],
